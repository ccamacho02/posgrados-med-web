...
class Contacto(models.Model):
    ...
    id_universidad = models.ForeignKey(Universidad, on_delete=models.CASCADE, db_column='id_universidad')
...
class ProgramaAcademico(models.Model):
    codigo_snies = models.AutoField(primary_key=True, max_length=15)
    id_universidad = models.ForeignKey(Universidad, on_delete=models.CASCADE, db_column='id_universidad')
...
class Admision(models.Model):
    ...
    codigo_snies = models.ForeignKey(ProgramaAcademico, on_delete=models.CASCADE, db_column='codigo_snies')
